    ...
    <div className="space-y-4">
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        <div className="bg-blue-50 p-4 rounded-lg">
          <p className="text-sm text-blue-600 font-medium">{t.totalRecords}</p>
          <p className="text-2xl font-bold text-blue-900">{editableData.length}</p>
        </div>
        <div className="bg-green-50 p-4 rounded-lg">
          <p className="text-sm text-green-600 font-medium">{t.totalAmount}</p>
        ...
        <table className="w-full border-collapse border border-gray-200">
          <thead>
            <tr className="bg-gray-50">
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.datum}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.betrag}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.beschreibung}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.kategorie}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.rechnungsnummer}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.unternehmen}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.mwst_betrag}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.mwst_satz}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.verwendungszweck}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.gegenkonto}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.transaktionstyp}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.betrag_brutto}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.columns.betrag_netto}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.actions.edit}</th>
              <th className="border border-gray-200 px-4 py-2 text-left text-sm font-medium text-gray-900">{t.actions.delete}</th>
            </tr>
          </thead>
          <tbody>
